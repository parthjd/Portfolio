      ...
      <main className="about-main">
        <div className="about-content">
          <p className="bio">
            ...
            voluptatibus quas deserunt enim cumque beatae dolore quam assumenda
            corrupti. Magnam explicabo similique aut laboriosam ab debitis
            maiores culpa, eligendi, mollitia deleniti repellendus quia.
            <br />
            <br />
          ...
          <img className="signature" src={require("../images/signature.png")} />
        </div>
